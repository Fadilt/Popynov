...
function initSong() {
    myAudio.addEventListener("loadeddata", function() {
        var durationSong = this.duration;
        myAudio.duration = durationSong;
        document.getElementById("seekbar").max = durationSong;
        document.getElementById("total").innerHTML = secondsToMs(durationSong);
